...
type Qos interface {
	AddQos(qosName, qosType string, externalIDs map[string]string) error
	UpdateQos(qosName string, qosType string, externalIDs map[string]string, fields ...interface{}) error
	DeleteQos(qosName string) error
}
